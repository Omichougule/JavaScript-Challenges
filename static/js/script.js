...
//     document.getElementById('rps-reset').remove();
...
//     // var paperImg = document.createElement('img');
//     var rps = document.getElementById('flex-box-rps');
//     rps.innerHTML = "<img id='rock' height=150 width=150 src='" + imagesDatabase['rock'] + "' alt='' onclick='rpsGame(this)'>" +
//             "<img id='paper' height=150 width=150 src='" + imagesDatabase['paper'] + "' alt='' onclick='rpsGame(this)'>" +
//             "<img id='scissors' height=150 width=150 src='" + imagesDatabase['scissors'] + "' alt='' onclick='rpsGame(this)'>";
//     document.getElementById('flex-box-rps').appendChild(rps);
...
function rpsFrontEnd(humanImageChoice, botImageChoice, finalMessage){
    ...
    // resetButtonDiv.innerHTML = "<button class='btn btn-success' id='rps-reset' onclick='rpsReset()'>Reset</button>";
    // document.getElementById('container-3').appendChild(resetButtonDiv);
...
function updateScore (card, activePlayer) {
    // If adin 11 keeps me below 21, ad 11. Otherwisw, add 1
    if ( card === 'A') {
